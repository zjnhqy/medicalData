...
export default [
  ...
  // },
  {
    ...
    datasets: [
      {
        name: 'img.glance',
        url: `https://raw.githubusercontent.com/zjnhqy/medicalData/main/00_img.glance`,
      },
    ],
    acknowledgement: 'Philips Research, Hamburg, Germany',
    description: 'Rotational C-arm x-ray scan of the arteries of the right half of a human head. A contrast agent was injected into the blood and an aneurism is present.',
  },
  {
    ...
    datasets: [
      {
        name: 'gt.glance',
        url: `https://raw.githubusercontent.com/zjnhqy/medicalData/main/00_gt.glance`,
      },
    ],
    acknowledgement: 'Philips Research, Hamburg, Germany',
    description: 'Rotational C-arm x-ray scan of the arteries of the right half of a human head. A contrast agent was injected into the blood and an aneurism is present.',
  },
  {
    ...
    datasets: [
      {
        name: 'pred.glance',
        url: `https://raw.githubusercontent.com/zjnhqy/medicalData/main/00_pred.glance`,
      },
    ],
    acknowledgement: 'Philips Research, Hamburg, Germany',
    description: 'Rotational C-arm x-ray scan of the arteries of the right half of a human head. A contrast agent was injected into the blood and an aneurism is present.',
